          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.folder_open_rounded, color: Color(0xFF8B5CF6), size: 22),
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      InkWell(
                        onTap: () => _loadDirectory(Platform.isWindows ? 'C:\\' : '/'),
                        child: const Padding(
                          padding: EdgeInsets.symmetric(horizontal: 4, vertical: 2),
                          child: Icon(Icons.dns_rounded, size: 14, color: Colors.white54),
                        ),
                      ),
                        ...
                        InkWell(
                          onTap: () {
                            ...
                            final targetPath = (Platform.isWindows ? '' : '/') +
                                targetSegs.join(Platform.isWindows ? r'\' : '/');
