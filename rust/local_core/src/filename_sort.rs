//! Vendored directly from `vendor/mimageviewer/src/filename_sort.rs` (MIT).
//!
//! The file manager calls this module instead of maintaining a second natural-sort
//! implementation, including the Windows `LCMapStringEx` key path.
