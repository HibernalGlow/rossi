...
fn wire__crate__api__local__media_formats_set_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_image = <Vec<String>>::sse_decode(&mut deserializer);
            let api_video = <Vec<String>>::sse_decode(&mut deserializer);
            let api_extra_video = <Vec<String>>::sse_decode(&mut deserializer);
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok({
                    crate::api::local::media_formats_set(api_image, api_video, api_extra_video);
                })?;
                Ok(output_ok)
            })())
        },
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        126 => wire__crate__api__mimage_onnx__mimage_onnx_upscale_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
